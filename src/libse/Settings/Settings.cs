...
namespace Nikse.SubtitleEdit.Core.Settings
{
    ...
    public class Settings
    {
        ...
        public static Settings CustomDeserialize(string fileName)
        {
            ...
            subNode = node.SelectSingleNode("TagsInToggleCustomTags2");
            if (subNode != null)
            {
                settings.General.TagsInToggleCustomTags2 = subNode.InnerText;
            }

            subNode = node.SelectSingleNode("TagsInToggleCustomTags3");
            if (subNode != null)
            {
                settings.General.TagsInToggleCustomTags3 = subNode.InnerText;
            }
        ...
        public static string CustomSerialize(Settings settings)
        {
            ...
            using (var xmlWriter = XmlWriter.Create(sb, xws))
            {
                ...
                xmlWriter.WriteElementString("TagsInToggleCustomTags2", settings.General.TagsInToggleCustomTags2);
                xmlWriter.WriteElementString("TagsInToggleCustomTags3", settings.General.TagsInToggleCustomTags3);
