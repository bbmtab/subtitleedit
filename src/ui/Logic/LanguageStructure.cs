namespace Nikse.SubtitleEdit.Logic
{
    ...
    public static class LanguageStructure
    {
        ...
        public class Main
        {
            ...
            public string BeforeToggleCustomTags { get; set; }
            ...
            public class MainMenu
            {
                ...
                public class AutoTranslateMenu
                {
                    ...
                    public string AutoTranslateLlmSubtrans { get; set; }
                    public string AutoTranslateViaCopyPaste { get; set; }                }
        ...
        public class Settings
        {
            ...
            public string ToggleCustomTags2 { get; set; }
            public string ToggleCustomTags3 { get; set; }
            public string ToggleMusicSymbols { get; set; }            public string Alignment { get; set; }
