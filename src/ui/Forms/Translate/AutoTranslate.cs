...
namespace Nikse.SubtitleEdit.Forms.Translate
{
    public sealed partial class AutoTranslate : Form
    {
        ...
        private void SetAutoTranslatorEngine()
        {
            ...
            if (engineType == typeof(LlmSubTrans))
            {
                FillUrls(new List<string>
                {
                    Configuration.Settings.Tools.LlmSubtransUrl,
                    "http://localhost:11434",
                    "https://api.openai.com/v1",
                });

                labelApiKey.Left = nikseComboBoxUrl.Right + 12;
                nikseTextBoxApiKey.Text = Configuration.Settings.Tools.LlmSubtransApiKey;
                nikseTextBoxApiKey.Left = labelApiKey.Right + 3;
                labelApiKey.Visible = true;
                nikseTextBoxApiKey.Visible = true;
                ...
                comboBoxFormality.DropDownStyle = ComboBoxStyle.DropDown;
                comboBoxFormality.Items.Clear();
                comboBoxFormality.Items.Add(Configuration.Settings.Tools.LlmSubtransModel);
                comboBoxFormality.Text = Configuration.Settings.Tools.LlmSubtransModel;
        ...
        private void SaveSettings(Type engineType)
        {
            ...
            if (engineType == typeof(LlmSubTrans))
            {
                Configuration.Settings.Tools.LlmSubtransApiKey = nikseTextBoxApiKey.Text.Trim();
                Configuration.Settings.Tools.LlmSubtransUrl = nikseComboBoxUrl.Text.Trim();
                Configuration.Settings.Tools.LlmSubtransModel = comboBoxFormality.Text.Trim();
            }
        }
